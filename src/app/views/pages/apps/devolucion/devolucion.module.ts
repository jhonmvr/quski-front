...
import { DevolucionProcesoComponent } from './devolucion-proceso/devolucion-proceso.component';
...
const routes: Routes = [
	{
		...
		children: [
			...
			},
			{
				...
				component: DevolucionProcesoComponent
			}
		]
	}
];
...
@NgModule({
	declarations: [
		...
		VerificacionFirmaComponent,
		ReporteEntregaGarantiaComponent,
		DevolucionProcesoComponent
	],
	imports: [
