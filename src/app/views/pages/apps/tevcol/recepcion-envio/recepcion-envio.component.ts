...
@Component({
  selector: 'kt-recepcion-envio',
  templateUrl: './recepcion-envio.component.html',
  styleUrls: ['./recepcion-envio.component.scss']
})
export class RecepcionEnvioComponent implements OnInit {
