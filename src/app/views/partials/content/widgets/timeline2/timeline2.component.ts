		...
		if (!this.data) {
			this.data = [
				...
				},
				{
					...
					attachment: '\n' +
						'<a href="$event.preventDefault();"><img src="./quski-front/assets/media/users/100_4.jpg" title="" alt=""></a>' +
						'<a href="$event.preventDefault();"><img src="./quski-front/assets/media/users/100_13.jpg" title="" alt=""></a>' +
						'<a href="$event.preventDefault();"><img src="./quski-front/assets/media/users/100_11.jpg" title="" alt=""></a>' +
						'<a href="$event.preventDefault();"><img src="./quski-front/assets/media/users/100_14.jpg" title="" alt=""></a>'
				},
				{
					time: '14:00',
