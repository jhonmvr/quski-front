...
export class Widget5Component implements OnInit {
	...
	ngOnInit() {
		if (!this.data) {
			this.data = shuffle([
				{
					pic: './quski-front/assets/media/products/product6.jpg',
				...
				{
					pic: './quski-front/assets/media/products/product10.jpg',
				...
				{
					pic: './quski-front/assets/media/products/product11.jpg',
