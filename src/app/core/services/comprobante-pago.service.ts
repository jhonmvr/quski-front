...
export class ComprobantePagoService extends BaseService {
  private rest = "comprobantePagoRestController/"
  ...
  listAllByIdNegociacion(idNegociacion?: number) {
    let serviceUrl = this.appResourcesUrl + "comprobantePagoRestController/listAllByIdNegociacion";
  ...
  agregarComprobante(comprobante: ComprobanteDto) {
    let serviceUrl = this.appResourcesUrl + "comprobantePagoRestController/agregarComprobante";
    let params = new HttpParams()
  ...
  eliminarComprobante(id?: number) {
    let serviceUrl = this.appResourcesUrl + "comprobantePagoRestController/eliminarComprobante";
    let params = new HttpParams()
